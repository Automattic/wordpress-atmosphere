...
**Gating:** `atmosphere_syncable_post_types`, `atmosphere_should_publish_comment`, `atmosphere_should_sync_reply`, `atmosphere_oauth_redirect_uri`, `atmosphere_client_metadata`.
