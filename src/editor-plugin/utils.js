 ...
 *
 * Sharing is opt-out: it is on unless the `atmosphere_disabled` meta is
 * truthy. Tolerates missing/undefined meta (a fresh post).
 *
...
export function isSharingEnabled( meta ) {
	return ! ( meta && meta.atmosphere_disabled );
}
